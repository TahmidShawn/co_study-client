            ...
            <div className="font-semibold  max-w-screen-lg mx-auto mt-8 text-[#333] relative">
                ...
                <div className="relative -mt-40 m-4">
                    <form className="bg-white max-w-xl w-full mx-auto shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] p-6 rounded-md">
                        ...
                        <div className="mt-10">
                            <label className="text-xs block mb-2">User Photo</label>
                            <div className="relative flex items-center">
                                {/* <input name="password" type="password" required className="w-full bg-transparent text-sm border-b border-gray-300 focus:border-blue-500 px-2 py-3 outline-none" placeholder="Enter password" /> */}
                                <input type="file" name="userPhoto" id="" className="w-full bg-transparent text-sm border-b border-gray-300 focus:border-blue-500 px-2 py-3 outline-none" />
                            </div>
                        </div>
